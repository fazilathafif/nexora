 ...
 *
 * nexora: true  — competitor platform; URL removed to keep users in-app.
 *                 BookCard renders a "Practice on Nexora →" CTA instead.
 */
...
export const RESOURCES = {
  ...
  gcse: {
    ...
    maths: [
      ...
      { title: 'Corbettmaths', type: 'free-online', nexora: true, desc: 'Videos, worksheets, 5-a-day' },
      { title: 'Mathswatch VLE', type: 'free-online', nexora: true, desc: 'Interactive video lessons' },
    ...
    english: [
      ...
      { title: 'BBC Bitesize GCSE English', type: 'free-online', nexora: true, desc: 'Free revision with examples' },
      { title: 'No Fear Shakespeare', type: 'free-online', url: 'https://www.sparknotes.com/shakespeare/', desc: 'Modern English side-by-side translations' },
    ...
    biology: [
      ...
      { title: 'Save My Exams — GCSE Biology', type: 'free-online', nexora: true, desc: 'Notes, flashcards, Q&A by topic' },
      { title: 'BBC Bitesize Biology', type: 'free-online', nexora: true, desc: 'Free revision organised by spec' },
    ],
    chemistry: [
      ...
      { title: 'Kognity GCSE Chemistry', type: 'free-online', nexora: true, desc: 'Interactive digital textbook' },
    ],
    physics: [
      ...
      { title: 'Physics and Maths Tutor', type: 'free-online', nexora: true, desc: 'Past papers, notes, videos' },
    ],
    history: [
      { title: 'GCSE History AQA Complete Revision', type: 'revision', publisher: 'CGP Books' },
      { title: 'BBC Bitesize History', type: 'free-online', nexora: true, desc: 'Event timelines & essay guides' },
      { title: 'Seneca Learning — History', type: 'free-online', nexora: true, desc: 'AI-powered smart revision' },
    ],
    geography: [
  ...
  alevel: {
    ...
    maths: [
      ...
      { title: 'Physics and Maths Tutor — A-Level Maths', type: 'free-online', nexora: true, desc: 'Past papers + worked solutions' },
      ...
      { title: 'Underground Mathematics', type: 'free-online', nexora: true, desc: 'Cambridge A-Level enrichment problems' },
    ],
    physics: [
      ...
      { title: 'Physics and Maths Tutor — Physics', type: 'free-online', nexora: true, desc: 'Past papers, mark schemes, notes' },
      { title: 'Khan Academy — Physics', type: 'free-online', nexora: true, desc: 'Free videos and practice' },
    ],
    chemistry: [
    ...
    biology: [
      ...
      { title: 'Save My Exams — A-Level Biology', type: 'free-online', nexora: true, desc: 'Exam-ready notes and Q&A' },
    ],
    history: [
  ...
  sat: {
    ...
    math: [
      ...
      { title: 'Khan Academy SAT Practice', type: 'free-online', nexora: true, desc: 'Official College Board-aligned adaptive practice' },
    ...
    english: [
      ...
      { title: 'Khan Academy SAT Reading & Writing', type: 'free-online', nexora: true, desc: 'Free lessons aligned to every skill' },
    ],
    reading: [
  ...
  act: {
    ...
    math: [
      ...
      { title: 'Khan Academy — ACT Math Skills', type: 'free-online', nexora: true, desc: 'Free aligned practice' },
    ],
    english: [
      { title: 'The Official ACT Prep Guide', author: 'ACT Inc.', type: 'textbook', publisher: 'Wiley' },
    ...
    science: [
      ...
      { title: 'CK-12 FlexBook — Life Science', type: 'free-online', nexora: true, desc: 'Free digital science textbook' },
    ],
    reading: [
      { title: 'Barron\'s ACT Premium', type: 'revision', publisher: 'Barron\'s Educational Series' },
      { title: 'PrepScholar ACT Study Guide', type: 'free-online', nexora: true, desc: 'Free strategy guides and diagnostics' },
    ],
  },
  ...
  ap: {
    ...
    calculus: [
      ...
      { title: 'Khan Academy — AP Calculus', type: 'free-online', nexora: true, desc: 'Full free course aligned to AP curriculum' },
    ...
    biology: [
      ...
      { title: 'Khan Academy — AP Biology', type: 'free-online', nexora: true, desc: 'Full AP course free' },
    ],
    chemistry: [
    ...
    statistics: [
      ...
      { title: 'Khan Academy — AP Statistics', type: 'free-online', nexora: true, desc: 'Full AP course free' },
    ],
  },
  ...
  psat: {
    ...
    math: [
      ...
      { title: 'Khan Academy SAT/PSAT Math', type: 'free-online', nexora: true, desc: 'PSAT and SAT share the same math curriculum' },
    ],
    english: [
      { title: 'Official PSAT/NMSQT Study Guide', author: 'College Board', type: 'textbook', publisher: 'College Board' },
