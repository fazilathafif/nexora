...
const heading = { fontWeight:900, fontSize:22, color:'#1E293B', marginBottom:20, letterSpacing:'-0.4px' }
const labelS  = { display:'block', fontSize:10, fontWeight:700, color:'#94A3B8', letterSpacing:'0.1em', marginBottom:5 }
const inputS  = { width:'100%', padding:'13px 14px', borderRadius:12, fontSize:14, background:'#F8FAFC', border:'1.5px solid #E2E8F0', color:'#1E293B', outline:'none', fontFamily:'Inter,sans-serif', transition:'border-color 0.2s', boxSizing:'border-box' }
const toggleRow = { textAlign:'center', marginTop:16, fontSize:13, color:'#64748B' }
const link    = { background:'none', border:'none', cursor:'pointer', color:'#FF6B35', fontWeight:700, fontSize:13, fontFamily:'Inter,sans-serif', padding:0 }
