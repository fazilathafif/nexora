...
const styles = {
  ...
  grid:      { display:'flex', flexDirection:'column', gap:16, width:'100%', maxWidth:480 },
  card:      { borderRadius:24, padding:'32px 24px', display:'flex', flexDirection:'column', alignItems:'center', gap:8, border:'2px solid transparent', cursor:'pointer', transition:'transform 0.2s, box-shadow 0.2s', textAlign:'center' },
