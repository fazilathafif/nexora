        ...
        /* Sign in / Sign up form */
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{width:'100%',display:'flex',alignItems:'center',justifyContent:'center',gap:10,background:'#fff',border:`1.5px solid ${dark?'#2D2D50':'#E2E8F0'}`,borderRadius:12,padding:'11px',fontWeight:700,fontSize:14,color:'#1E293B',cursor:'pointer',fontFamily:'Inter,sans-serif',marginBottom:16,transition:'box-shadow 0.2s'}}
